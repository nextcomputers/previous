...
uae_u32 REGPARAM3 op_illg (uae_u32) REGPARAM;
void REGPARAM3 op_unimpl (uae_u16) REGPARAM;
...
void m68k_go (int);
void m68k_dumpstate (FILE *, uaecptr *);
void m68k_disasm (FILE *, uaecptr, uaecptr *, int);
